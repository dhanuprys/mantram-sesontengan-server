...
function HomeHeader() {
    ...
    const { setFontSize } = useFontChanger();
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 z-[50] w-screen h-screen transition-all flex ${isSidebarOpen ? '' : '-translate-x-[100vw]'}`}>
                <div className="w-[80vw] md:w-[20vw] h-screen bg-white shadow-2xl flex flex-col p-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="pl-4">
                            <div onClick={() => setFontSize('s')} className="flex items-center gap-2 p-4 rounded hover:cursor-pointer hover:bg-slate-100">
                                <div>
                            ...
                            <div onClick={() => setFontSize('m')} className="flex items-center gap-2 p-4 rounded hover:cursor-pointer hover:bg-slate-100">
                                <div>
                            ...
                            <div onClick={() => setFontSize('l')} className="flex items-center gap-2 p-4 rounded hover:cursor-pointer hover:bg-slate-100">
                                <div>
